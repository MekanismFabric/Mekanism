...
import mekanism.api.util.FluidStack;
...
public class TextComponentUtil {
     ...
     */
    public static MutableText color(MutableText component, int color) {
    ...
    public static MutableText build(Object... components) {
        ...
        for (Object component : components) {
            ...
            if (component instanceof IHasTextComponent hasTextComponent) {
            ...
            } else if (component instanceof Text c) {
                //Just append if a text component is being passed
                current = c.copy();
            } else if (component instanceof Formatting formatting) {
                cachedStyle = cachedStyle.withFormatting(formatting);
                ...
                current = translate(block.getTranslationKey());
            } else if (component instanceof Item item) {
                current = translate(item.getTranslationKey());
            } else if (component instanceof ItemStack stack) {
                current = stack.getName().copy();
            } else if (component instanceof FluidStack stack) {
                current = stack.getFluidVariant().getFluid().getBucketItem().getName().copy();
            } else if (component instanceof Fluid fluid) {
                current = translate(fluid.getBucketItem().getTranslationKey());
    ...
    private static MutableText getTranslatedBoolean(boolean bool) {
     ...
     */
    public static MutableText getString(String component) {
        return Text.literal(cleanString(component));
    }
     ...
     * @return Translation Text Component.
     */
    public static MutableText smartTranslate(String key, Object... components) {
        ...
        for (Object component : components) {
            ...
            //Formatting
                ...
                cachedStyle = cachedStyle.withColor(color.getColor());
                continue;
            } else if (component instanceof Formatting formatting && !hasStyleType(cachedStyle, formatting)) {
