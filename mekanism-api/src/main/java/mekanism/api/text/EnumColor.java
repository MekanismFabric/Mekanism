...
import mekanism.api.util.MathUtils;
...
public enum EnumColor implements IIncrementalEnum<EnumColor> {
    ...
    DARK_RED("\u00a74", APILang.COLOR_DARK_RED, "Dark Red", "dark_red", new int[]{201, 7, 31}, MapColor.DARK_RED, null),
    ...
    AQUA("\u00a7b", APILang.COLOR_AQUA, "Aqua", "aqua", new int[]{48, 255, 249}, MapColor.LIGHT_BLUE, null),
