...
public class RefinedGlowstone implements ConfigData, ISpawnChance {
    ...
    @Comment("The chance that mobs can spawn with Refined Glowstone Swords.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Refined Glowstone Helmets.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Refined Glowstone Chestplates.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Refined Glowstone Leggings.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Refined Glowstone Boots.")
