...
public class LapisLazuli implements ConfigData, ISpawnChance {
    ...
    @Comment("The chance that mobs can spawn with Lapis Lazuli Swords.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Lapis Lazuli Helmets.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Lapis Lazuli Chestplates.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Lapis Lazuli Leggings.")
    ...
    @ConfigEntry.Gui.Tooltip
    @SpecDoubleInRange(min = 0.0D, max = 1.0D)
    @Comment("The chance that mobs can spawn with Lapis Lazuli Boots.")
