...
public abstract class IItemMaterialHelper implements ToolMaterial {
     ...
     * reobfuscating.
     *
     * @apiNote Both {@link #getItemEnchantability()} and {@link IArmorMaterialHelper#getArmorEnchantability()} are wrapped back into a single method in
     ...
     * reobfuscating.
     *
     * @apiNote Both {@link #getItemRepairMaterial()} and {@link IArmorMaterialHelper#getArmorRepairMaterial()} are wrapped back into a single method in
     * {@link BaseMekanismMaterial}
     */
    @NotNull
    @Override
